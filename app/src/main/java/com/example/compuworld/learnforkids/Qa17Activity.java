...
public class Qa17Activity extends program implements
...
// TODO: Add adView to your view hierarchy.
        ...
        backmain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View e) {
                ...
                startActivity(new Intent(Qa17Activity.this,GroupAActivity.class));
                finish();
...
//        mRewardedVideoAd.destroy(this);
    ...
    protected void onStart() {
        ...
        super.onStart();
        question.setText(".......  اكثر فريق فاز بالدورى المصرى ");
        first.setText("الاهلى");
        second.setText("الانتاج الحربى");
        third.setText("الزمالك");
            ...
            if (score == 16) {
                first.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        getContentResolver().update(PetEntry.CONTENT_URI, values, null, null);
                        startActivity(new Intent(Qa17Activity.this, Qa18Activity.class));
                        finish();
