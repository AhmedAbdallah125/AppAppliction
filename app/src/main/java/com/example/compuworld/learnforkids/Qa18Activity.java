...
public class Qa18Activity extends program implements
...
// TODO: Add adView to your view hierarchy.
        ...
        backmain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View e) {
                ...
                startActivity(new Intent(Qa18Activity.this,GroupAActivity.class));
                finish();
...
//        mRewardedVideoAd.destroy(this);
    ...
    protected void onStart() {
        ...
        super.onStart();
        question.setText("....هو الشاعر الملقب بأمير الشعراء");
        first.setText("احمد شوقى");
        second.setText("خليل مطران");
        third.setText("نزار قبانى");
            ...
            if (score == 17) {
                first.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        getContentResolver().update(PetEntry.CONTENT_URI, values, null, null);
                        startActivity(new Intent(Qa18Activity.this, Qa19Activity.class));
                        finish();
