...
public class Q4dActivity extends program implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_q4d);
...
// TODO: Add adView to your view hierarchy.
        ...
        backmain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View e) {
                ...
                startActivity(new Intent(Q4dActivity.this,GroupAActivity.class));
                finish();
...
// for rewarding video
        ...
        mRewardedVideoAd.loadAd("ca-app-pub-3940256099942544/5224354917",new AdRequest.Builder().build());
        super.onStart();
        question.setText("اول دوله افريقيه تستضيف نهائيات كاس العالم....");
        first.setText("الجزائر");
        second.setText("جنوب افريقيا");
        third.setText("المغرب");
            ...
            if (score == 3) {
                second.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        getContentResolver().update(PetEntry.CONTENT_URI, values, null, null);
                        mRewardedVideoAd.loadAd("",new AdRequest.Builder().build());
                        startActivity(new Intent(Q4dActivity.this, Qa5Activity.class));
                        finish();
