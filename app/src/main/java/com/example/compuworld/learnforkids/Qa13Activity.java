...
public class Qa13Activity extends program implements
...
// TODO: Add adView to your view hierarchy.
        ...
        backmain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View e) {
                ...
                startActivity(new Intent(Qa13Activity.this,GroupAActivity.class));
                finish();
...
//        mRewardedVideoAd.destroy(this);
    ...
    protected void onStart() {
        ...
        mRewardedVideoAd.loadAd("ca-app-pub-3940256099942544/5224354917",new AdRequest.Builder().build());
        super.onStart();
        question.setText("النبى الملقب بابو الانبياء....");
        first.setText("سيدنا ابراهيم عليه السلام");
        second.setText("سيدنا يونس عليه السلام");
        third.setText("سيدنا عيسى عليه السلام");
            ...
            if (score == 12) {
                first.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        getContentResolver().update(PetEntry.CONTENT_URI, values, null, null);
                        startActivity(new Intent(Qa13Activity.this, Qa14Activity.class));
                        finish();
