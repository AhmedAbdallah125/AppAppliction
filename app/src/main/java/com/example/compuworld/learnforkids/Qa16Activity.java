...
public class Qa16Activity extends program implements
...
// TODO: Add adView to your view hierarchy.
        ...
        backmain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View e) {
                ...
                startActivity(new Intent(Qa16Activity.this,GroupAActivity.class));
                finish();
...
//        mRewardedVideoAd.destroy(this);
    ...
    protected void onStart() {
        ...
        mRewardedVideoAd.loadAd("ca-app-pub-3940256099942544/5224354917",new AdRequest.Builder().build());
        super.onStart();
        question.setText("يبلغ اليوم على كوكب نبتون....");
        first.setText("16ساعه");
        second.setText("24ساعه");
        third.setText("30ساعه");
            ...
            if (score == 15) {
                first.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        getContentResolver().update(PetEntry.CONTENT_URI, values, null, null);
                        startActivity(new Intent(Qa16Activity.this, Qa17Activity.class));
                        finish();
