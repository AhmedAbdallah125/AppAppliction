...
public class Qb1Activity extends program implements
...
private RewardedVideoAd mRewardedVideoAd;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_qb1);
...
public void onClick(View e) {
        ...
        startActivity(new Intent(Qb1Activity.this,GroupBActivity.class));
        finish();
...
protected void onStart() {
        ...
        mRewardedVideoAd.loadAd("ca-app-pub-3940256099942544/5224354917",new AdRequest.Builder().build());
        super.onStart();
        question.setText("اكبر الكواكب حجما فى المجموعه الشمسيه ....");
        first.setText("المشترى");
        second.setText("زحل");
        third.setText("المريخ");
...
public void onClick(View view) {
        ...
        getContentResolver().update(PetEntry.CONTENT_URI, values, null, null);
        mRewardedVideoAd.loadAd("",new AdRequest.Builder().build());
        startActivity(new Intent(Qb1Activity.this, Qb2Activity.class));
        finish();
        }
        });
        if(va==0) {
