...
public class Qa9Activity extends program implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_qa9);
...
// TODO: Add adView to your view hierarchy.
        ...
        backmain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View e) {
                ...
                startActivity(new Intent(Qa9Activity.this,GroupAActivity.class));
                finish();
...
// for rewarding video
        ...
        mRewardedVideoAd.loadAd("ca-app-pub-3940256099942544/5224354917",new AdRequest.Builder().build());
        super.onStart();
        question.setText("تستغرق السنه على كوكب زحل ؟");
        first.setText("15.6 سنه ارضيه");
        second.setText("29.4 سنه ارضيه");
        third.setText("32.3 سنه ارضيه");
...
// rewarding vido
            ...
            if (score == 8) {
                second.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        getContentResolver().update(PetEntry.CONTENT_URI, values, null, null);
                        startActivity(new Intent(Qa9Activity.this, Qa10Activity.class));
                        finish();
        ...
        if(score>8){
            second.setBackgroundColor(Color.parseColor("#FFC107"));
            first.setBackgroundColor(Color.parseColor("#FFECB3"));
