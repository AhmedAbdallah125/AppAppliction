...
public class Qa5Activity extends program implements
...
//        question = (TextView) findViewById(R.id.question);
        ...
        backmain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View e) {
                ...
                startActivity(new Intent(Qa5Activity.this,GroupAActivity.class));
                finish();
...
// for rewarding video
        ...
        mRewardedVideoAd.loadAd("ca-app-pub-3940256099942544/5224354917",new AdRequest.Builder().build());
        super.onStart();
//        question.setText("تعتبر.....هى عاصمه مصر");
        first.setText("القاهره");
        second.setText("الاسكندريه");
        third.setText("الجيزه");
            ...
            if (score == 4) {
                first.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        getContentResolver().update(PetEntry.CONTENT_URI, values, null, null);
                        mRewardedVideoAd.loadAd("",new AdRequest.Builder().build());
                        startActivity(new Intent(Qa5Activity.this, Qa6Activity.class));
                        finish();
