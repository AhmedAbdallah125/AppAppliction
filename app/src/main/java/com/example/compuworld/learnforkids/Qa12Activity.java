...
public class Qa12Activity extends program implements
...
// TODO: Add adView to your view hierarchy.
        ...
        backmain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View e) {
                ...
                startActivity(new Intent(Qa12Activity.this,GroupAActivity.class));
                finish();
...
//        mRewardedVideoAd.destroy(this);
    ...
    protected void onStart() {
        ...
        mRewardedVideoAd.loadAd("ca-app-pub-3940256099942544/5224354917",new AdRequest.Builder().build());
        super.onStart();
        question.setText("اللى اختشوا ...");
        first.setText("ماتوا");
        second.setText("عاشوا");
        third.setText("رحلوا");
            ...
            if (score == 11) {
                first.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        getContentResolver().update(PetEntry.CONTENT_URI, values, null, null);
                        startActivity(new Intent(Qa12Activity.this, Qa13Activity.class));
                        finish();
