...
public class Qd2Activity extends program implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_qd2);
...
// TODO: Add adView to your view hierarchy.
        ...
        backmain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View e) {
                ...
                startActivity(new Intent(Qd2Activity.this,GroupDActivity.class));
                finish();
...
//        mRewardedVideoAd.destroy(this);
    ...
    protected void onStart() {
        ...
        mRewardedVideoAd.loadAd("ca-app-pub-3940256099942544/5224354917",new AdRequest.Builder().build());
        super.onStart();
        question.setText("من هى اقدم مدينة فى قارة اسيا؟ ....");
        first.setText("اريحه الفلسطينيه");
        second.setText("دمشق");
        third.setText("شانغهاى");
            ...
            if (score == 61) {
                first.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        getContentResolver().update(PetEntry.CONTENT_URI, values, null, null);
                        mRewardedVideoAd.loadAd("",new AdRequest.Builder().build());
                        startActivity(new Intent(Qd2Activity.this, Qd3Activity.class));
                        finish();
                    }
                });
                if(va==0) {
