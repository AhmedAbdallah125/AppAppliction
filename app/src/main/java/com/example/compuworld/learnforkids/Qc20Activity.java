...
public class Qc20Activity extends program implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_qc20);
...
// TODO: Add adView to your view hierarchy.
        ...
        backmain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View e) {
                ...
                startActivity(new Intent(Qc20Activity.this,GroupCActivity.class));
                finish();
...
//        mRewardedVideoAd.destroy(this);
    ...
    protected void onStart() {
        ...
        mRewardedVideoAd.loadAd("ca-app-pub-3940256099942544/5224354917",new AdRequest.Builder().build());
        super.onStart();
        question.setText("من الاديب العربى الذى حصل على جائزة نوبل فى الادب عام 1988 م؟ ....");
        first.setText("نجيب محفوظ");
        second.setText("احمد شوقى");
        third.setText("العقاد");
            ...
            if (score == 59) {
                first.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Toast.makeText(view.getContext(), "اجابه صحيحه" + "\n" + "يمكنك الذهاب للمرحله التاليه", Toast.LENGTH_SHORT).show();
                        score++;
                        va=0;
                        vb=0;
                        ContentValues values = new ContentValues();
