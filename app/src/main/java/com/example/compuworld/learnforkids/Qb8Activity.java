...
public class Qb8Activity extends program implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_qb8);
...
// TODO: Add adView to your view hierarchy.
        ...
        backmain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View e) {
                ...
                startActivity(new Intent(Qb8Activity.this,GroupBActivity.class));
                finish();
...
//        mRewardedVideoAd.destroy(this);
    ...
    protected void onStart() {
        ...
        mRewardedVideoAd.loadAd("ca-app-pub-3940256099942544/5224354917",new AdRequest.Builder().build());
        super.onStart();
        question.setText("يوجد نهر الامازون فى قارة ....");
            ...
            if (score == 27) {
                first.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        getContentResolver().update(PetEntry.CONTENT_URI, values, null, null);
                        mRewardedVideoAd.loadAd("",new AdRequest.Builder().build());
                        startActivity(new Intent(Qb8Activity.this, Qb9Activity.class));
                        finish();
                    }
                });
                if(va==0) {
