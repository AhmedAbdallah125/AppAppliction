...
public class Qa8Activity  extends program implements
...
private RewardedVideoAd mRewardedVideoAd;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_qa8);
...
public void onClick(View e) {
        ...
        startActivity(new Intent(Qa8Activity.this,GroupAActivity.class));
        finish();
...
// for rewarding video
        ...
        mRewardedVideoAd.loadAd("ca-app-pub-3940256099942544/5224354917",new AdRequest.Builder().build());
        super.onStart();
        question.setText("توجد كولومبيا فى قاره؟");
...
public void onClick(View view) {
        ...
        getContentResolver().update(PetEntry.CONTENT_URI, values, null, null);
        mRewardedVideoAd.loadAd("",new AdRequest.Builder().build());
        startActivity(new Intent(Qa8Activity.this, Qa9Activity.class));
        finish();
