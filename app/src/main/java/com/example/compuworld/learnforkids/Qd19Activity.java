...
public class Qd19Activity extends program implements
...
private RewardedVideoAd mRewardedVideoAd;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_qd19);
...
// TODO: Add adView to your view hierarchy.
        ...
        backmain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View e) {
                ...
                startActivity(new Intent(Qd19Activity.this,GroupDActivity.class));
                finish();
...
//        mRewardedVideoAd.destroy(this);
    ...
    protected void onStart() {
        ...
        mRewardedVideoAd.loadAd("ca-app-pub-3940256099942544/5224354917",new AdRequest.Builder().build());
        super.onStart();
        question.setText("الصحابى الملقب بأبى تراب ....");
        first.setText("على بن ابى طالب رضى الله عنه");
        second.setText("الزبير بن العوام رضى الله عنه");
        third.setText("ابو بكر الصديق رضى الله عنه");
            ...
            if (score == 78) {
                first.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        getContentResolver().update(PetEntry.CONTENT_URI, values, null, null);
                        mRewardedVideoAd.loadAd("",new AdRequest.Builder().build());
                        startActivity(new Intent(Qd19Activity.this, Qd20Activity.class));
                        finish();
                    }
                });
                if(va==0) {
