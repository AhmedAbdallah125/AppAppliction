...
public class Qb14Activity extends program implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_qb14);
...
// TODO: Add adView to your view hierarchy.
        ...
        backmain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View e) {
                ...
                startActivity(new Intent(Qb14Activity.this,GroupBActivity.class));
                finish();
...
//        mRewardedVideoAd.destroy(this);
    ...
    protected void onStart() {
        ...
        mRewardedVideoAd.loadAd("ca-app-pub-3940256099942544/5224354917",new AdRequest.Builder().build());
        super.onStart();
        question.setText("من هو النبى الذى ابتلعه الحوت ؟ ....");
        first.setText("سيدنا يونس عليه السلام ");
        second.setText("سيدنا يوسف عليه السلام");
        third.setText("سيدنا نوح عليه السلام");
            ...
            if (score == 33) {
                first.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        getContentResolver().update(PetEntry.CONTENT_URI, values, null, null);
                        mRewardedVideoAd.loadAd("",new AdRequest.Builder().build());
                        startActivity(new Intent(Qb14Activity.this, Qb15Activity.class));
                        finish();
                    }
                });
                if(va==0) {
