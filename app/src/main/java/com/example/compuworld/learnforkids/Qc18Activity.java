...
public class Qc18Activity extends program implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_qc18);
...
// TODO: Add adView to your view hierarchy.
        ...
        backmain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View e) {
                ...
                startActivity(new Intent(Qc18Activity.this,GroupCActivity.class));
                finish();
...
//        mRewardedVideoAd.destroy(this);
    ...
    protected void onStart() {
        ...
        mRewardedVideoAd.loadAd("ca-app-pub-3940256099942544/5224354917",new AdRequest.Builder().build());
        super.onStart();
        question.setText("تعتبر .... عاصمة اليابان");
        first.setText("طوكيو");
        second.setText("ناغويا");
        third.setText("بكين");
            ...
            if (score == 57) {
                first.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        getContentResolver().update(PetEntry.CONTENT_URI, values, null, null);
                        mRewardedVideoAd.loadAd("",new AdRequest.Builder().build());
                        startActivity(new Intent(Qc18Activity.this, Qc19Activity.class));
                        finish();
                    }
                });
                if(va==0) {
