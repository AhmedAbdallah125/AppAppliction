...
public class Qa6Activity extends program implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_qa6);
...
// TODO: Add adView to your view hierarchy.
        ...
        backmain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View e) {
                ...
                startActivity(new Intent(Qa6Activity.this,GroupAActivity.class));
                finish();
...
// for rewarding video
        ...
        mRewardedVideoAd.loadAd("ca-app-pub-3940256099942544/5224354917",new AdRequest.Builder().build());
        super.onStart();
        question.setText("ياما جاب ....لامه");
        first.setText("الحمام");
        second.setText("الغراب");
        third.setText("العصفور");
            ...
            if (score == 5) {
                second.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        startActivity(new Intent(Qa6Activity.this, Qa7Activity.class));
                        finish();
