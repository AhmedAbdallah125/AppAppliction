...
public class Qa7Activity extends program implements
...
// TODO: Add adView to your view hierarchy.
        ...
        backmain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View e) {
                ...
                startActivity(new Intent(Qa7Activity.this,GroupAActivity.class));
                finish();
...
// for rewarding video
        ...
        mRewardedVideoAd.loadAd("ca-app-pub-3940256099942544/5224354917",new AdRequest.Builder().build());
        super.onStart();
        question.setText("اللقب الذى عرف به عمر بن الخطاب رضى الله عنه");
        first.setText("اسد الله");
        second.setText("الصديق");
        third.setText("الفاروق");
...
// rewarding vido
            ...
            if (score == 6) {
                third.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        startActivity(new Intent(Qa7Activity.this, Qa8Activity.class));
                        finish();
        ...
        if(score>6){
            third.setBackgroundColor(Color.parseColor("#FFC107"));
